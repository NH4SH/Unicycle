...
export default function ConnectCancelPage({ searchParams }: ConnectCancelPageProps) {
  const returnHref = searchParams?.productId ? "/connect-demo#storefront" : "/connect-demo";
            ...
            <div className="relative space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-xl text-muted-foreground">
                  The Connect demo checkout was canceled before payment completed. You can jump back into the storefront and
