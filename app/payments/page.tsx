      ...
      <section className="grid gap-8 border-b border-border/80 pb-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        <div className="space-y-5">
          <div className="flex flex-wrap gap-2">
            <Badge variant="outline">Seller payments</Badge>
          ...
          <div className="space-y-3">
            ...
            <h1 className="max-w-4xl font-display text-4xl font-extrabold tracking-[-0.04em] md:text-6xl md:leading-[0.95]">
              Onboard sellers, publish products, and route payouts through HoosFinds.
            </h1>
            <p className="max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">
              HoosFinds stays in charge of pricing and fee collection while sellers onboard with Stripe, publish
              products from the platform, and receive payouts through destination charges.
            </p>
          </div>
