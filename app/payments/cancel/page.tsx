...
export default function PaymentsCancelPage({ searchParams }: PaymentsCancelPageProps) {
  const returnHref = searchParams?.productId ? "/payments#storefront" : "/payments";
        ...
        <CardContent className="space-y-6 p-8">
            ...
            <div className="relative space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-xl text-muted-foreground">
                  Checkout was canceled before payment completed. You can jump back into the storefront and try again
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button asChild variant="secondary">
              <Link href="/market">Keep browsing HoosFinds</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
