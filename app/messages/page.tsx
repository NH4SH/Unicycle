      ...
      <div className="grid gap-4 border-b border-border/80 pb-6 md:grid-cols-[1fr_auto] md:items-end">
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">
            HoosFinds messages are where buyers and sellers ask fit or condition questions, settle pickup timing, and move a sale into buyer confirmation once the item is actually handed off.
          </p>
        </div>
